...
NAME_OF_R2_FILE.fastq | \
samtools view -@ 4 -Sb - > R2_only_hits.bam

### SUBMIT THE FASTA AND BAM FILES TO EXPRESS FOR CALCULATING DE ACROSS THE TRANSCRIPTOME ###
express --output-dir express_using_R2_only NAME_OF_FASTA_FILE.fasta R2_only_hits.bam

### REMOVE THE BAM FILE SINCE IT IS NO LONGER NEEDED ####
rm -rf R2_only_hits.bam
